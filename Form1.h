...
namespace CppCLRWinFormsProject {
	...
	public:
		Form1(void)
		{
			...
			bmpCorazon = gcnew Bitmap("assets/corazon.png");
			bmpAliado = gcnew Bitmap("assets/aliado.png");
			...
			aliado = new Aliado(670, 180); // Ubicacion donde esta la casa
...
#pragma endregion
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		map->draw(buffer->Graphics, bmpMap, *player, *aliado, bmpAliado);
		player->draw(buffer->Graphics, bmpPlayer);
		gameService->drawHeart(buffer->Graphics, bmpCorazon);
		//gameService->drawAliado(buffer->Graphics, bmpAliado);
